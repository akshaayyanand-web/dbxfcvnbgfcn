...
credibility stack (studies / numbers / "N+ people" / guarantee); offer / urgency;
product reference image (path or URL); format (long-form ~100-150s or 30s cutdown).
...
Save as [run_dir]/script.txt — narrator VO only, timestamped by beat.
